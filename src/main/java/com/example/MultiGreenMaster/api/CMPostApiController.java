...
import com.example.MultiGreenMaster.dto.CMGetpostForm;
import com.example.MultiGreenMaster.dto.CMPostForm;
import com.example.MultiGreenMaster.entity.CMPost;
import com.example.MultiGreenMaster.entity.User;
import com.example.MultiGreenMaster.service.CMPostService;
...
public class CMPostApiController extends SessionCheckController {
    ...
    public ResponseEntity<List<CMGetpostForm>> listPosts() {
        ...
        List<CMGetpostForm> postForms = posts.stream().map(post -> new CMGetpostForm(
                post.getId(),
                post.getUser(),
                post.getTitle(),
                post.getLikeCount(),
