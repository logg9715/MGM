...
public class CMCommentCtl {
    ...
    @PostMapping("/new")
    public String createComment(CMCommentFRM form, HttpServletRequest request) {
        ...
        if (post != null) {
            CMCommentENT comment = new CMCommentENT();
    ...
    public int likeComment(@PathVariable Long id) {
        ...
        CMCommentENT comment = cmCommentService.findCommentById(id);
